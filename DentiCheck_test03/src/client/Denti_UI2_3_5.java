...
public class Denti_UI2_3_5 extends JFrame {

	private JPanel contentPane;

	public Denti_UI2_3_5() {
		setBounds(100, 100, 757, 695);
		setLocationRelativeTo(null);
		setTitle("치아 건강정보- 치아에 좋은 음식");
		...
		String imgPath = ".\\images\\2_3\\2_3_5_0.JPG";
		ImageIcon originIcon = new ImageIcon(imgPath);  

		Image originImg = originIcon.getImage(); 
		Image changedImg = originImg.getScaledInstance(740, 4800, Image.SCALE_SMOOTH );
